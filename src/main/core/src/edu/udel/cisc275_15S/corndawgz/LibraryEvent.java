...
public class LibraryEvent extends GameScreen implements InputProcessor {
    ...
    public void show() {
    	...
    	texture = new Texture(Gdx.files.internal("locations/Library1.jpg"));
        texture2 = new Texture(Gdx.files.internal("locations/Library2.jpg"));
        texture3 = new Texture(Gdx.files.internal("locations/Library3.jpg"));
